...
export function evaluateApartment(inputs, address) {
  ...
  return {
    ...
    projection,
    exit: { exit_cap_rate_used: exit_cap / 100, year5_noi: yr5_noi, gross_exit_value: gross_exit, selling_costs: sell_costs, remaining_loan_balance: remaining_loan, net_proceeds, irr, equity_multiple },
    verdict: { overall, score: passes * 20, thresholds, red_flags, strengths, recommendation }
  }
}
